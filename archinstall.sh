...
parted -s $disk mkpart primary 1MiB 2048MiB
...
pacstrap -K /mnt base linux linux-firmware xfce4 kitty firefox wofi dolphin base-devel neovim grub efibootmgr
